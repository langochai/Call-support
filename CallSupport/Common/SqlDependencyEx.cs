...
namespace CallSupport.Common
{
    public sealed class SqlDependencyEx : IDisposable
    {
        ...
        #endregion ServiceBroker notification
        ...
        #endregion Notification Trigger
        ...
        #endregion Forced cleaning of database
        ...
        public string ConversationQueueName
        {
            get
            {
                return string.Format("ListenerQueue_{0}", Identity);
            }
        }
        ...
        public string ConversationServiceName
        {
            get
            {
                return string.Format("ListenerService_{0}", Identity);
            }
        }
        ...
        public string ConversationTriggerName
        {
            get
            {
                return string.Format("tr_Listener_{0}", Identity);
            }
        }
        ...
        public string InstallListenerProcedureName
        {
            get
            {
                return string.Format("sp_InstallListenerNotification_{0}", Identity);
            }
        }
        ...
        public string UninstallListenerProcedureName
        {
            get
            {
                return string.Format("sp_UninstallListenerNotification_{0}", Identity);
            }
        }
